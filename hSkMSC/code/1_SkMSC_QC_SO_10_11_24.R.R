...
setwd("files/")
resdir = 'omics1/ccNN/usftp21.novogene.com/01.RawData'
resdir2 = 'Qiu/SkMSC/usftp21.novogene.com/01.RawData/HSkMSC_cr'
...
qc_ensembl = list()
qc_ensembl[['HSkMSC']] = scQC(res_dir = 'Qiu/SkMSC/usftp21.novogene.com/01.RawData', tag = 'HSkMSC_cr', mito_genes = mito_genes, v1 = 4000, v2 = 100000, h1 = 0.009, h2 = 0.1, symbol = F)

qc_symbol = list()
qc_symbol[['HSkMSC']] = scQC(res_dir = 'Qiu/SkMSC/usftp21.novogene.com/01.RawData', tag = 'HSkMSC_cr', mito_genes = mito_genes, v1 = 4000, v2 = 100000, h1 = 0.009, h2 = 0.1, symbol = T)
